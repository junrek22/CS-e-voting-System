...
session_start();
include "db.php";
if(isset($_POST['submit_newPosition']) && $_SESSION['user_type'] == "Admin"){
    $position = ucfirst($_POST['position']);
    $description = ucfirst($_POST['description']);
    $passwordConfirm = $_POST['passwordConfirm'];
    $usernameQuery = $_SESSION['user_type'];
...
else if(isset($_POST['submit_edit_position']) && $_SESSION['user_type'] == "Admin"){
    $position = ucfirst($_POST['position']);
    $description = ucfirst($_POST['description']);
    $passwordConfirm = $_POST['passwordConfirm'];
    $usernameQuery = $_SESSION['user_type'];
