...
if(!isset($_SESSION['user_type']) || $_SESSION['user_type']!="Admin"){
    ...
    if(isset($_POST['submit_account_vote'])){
        ...
        if(in_array($profile_type, $allowedType)){
            ...
            $queryVoters = $conn->prepare("INSERT INTO voters (UserID, Precinct, Firstname, Lastname, Profile_pic, Status, acc_stat, vote_stat) VALUES ('$userID', '$randomPrecinct', '$firstname', '$lastname', '$profile_name', 'Valid', 'New','NOTVOTED')");
            $queryVoters->execute();
